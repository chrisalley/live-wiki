defmodule LiveWikiWeb.Router do
  ...
  scope "/", LiveWikiWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{LiveWikiWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", LiveWikiWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{LiveWikiWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", LiveWikiWeb do
    ...
    live_session :current_user,
      on_mount: [{LiveWikiWeb.UserAuth, :mount_current_user}] do
